...
//        NSParameterAssert(path && [path length]);
    ...
    pathFileSystemRepresentation = [path fileSystemRepresentation]; // GCSafeFileSystemRepresentation
...
//    if ([MacForgeKit shouldWarnAboutAMFI]) [MacForgeKit showAMFIWarning:self.window];
